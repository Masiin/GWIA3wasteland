...
_serverInfoString = format ["<t color='#A0FFFFFF'>TOP #%1 Wasteland %2</t>", call A3W_extDB_ServerID, worldName];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://toparma.com'>TOParma.com</a></t> Forums: <t color='#0091CD'><a href='http://forums.toparma.com'>forums.TOParma.com</a></t> TeamSpeak: ts.TOParma.com";
...
//_statsOnline = "http://www.toparma.com/s/" + _uid + "/s.html"; //Uncomment when stats go online
//_statsOffline = "addons\TOParmaInfo\stats.html"; //Uncomment when stats go online
