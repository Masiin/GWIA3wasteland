...
while {true} do
{
	...
	_serverString = format ["<t color='#A0FFFFFF'>GWIGaming #%1 Wasteland %2 : Server</t>", call A3W_extDB_ServerID, worldName];
	_serverString = format ["%1<br/><t color='#A0FFFFFF'>ts.gwigaming.com : TeamSpeak<br/>GWIGAMING.COM : Website/Stats/Forum</t>",_serverString];
	...
	{
		_tempString = format ["<t color='#CCCCCCCC'>GWI A3Wasteland %1<br/>gwigaming.com</t>", getText (configFile >> "CfgWorlds" >> worldName >> "description")];
